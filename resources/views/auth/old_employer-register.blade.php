...
@section('content')
{{-- this logic is handled by the laravel inside the controller in auth folder named register controller --}}
<div class="container">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('emp.register') }}">
                        ...
                        {{-- Hidden input so that we can insert the data into the database --}}
