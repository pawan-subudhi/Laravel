                ...
                <div class="col-md-9">
                  <div class="row">
                    ...
                    <div class="col-md-6 mb-3 mb-md-0">
                      ...
                      <input type="text" name="address" class="form-control form-control-block search-input  border-0 px-4" id="autocomplete" placeholder="city, province or region" onFocus="geolocate()" required>
                      </div>
                    </div>
                  </div>
                </div>
