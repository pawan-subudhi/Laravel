        ...
        <div class="row">
          <div class="col-md-12 mb-5 mb-md-0" data-aos="fade-up" data-aos-delay="100">
                  ...
                  <div class="job-details h-100">
                    <div class="p-3 align-self-center">
                      ...
                      <div class="d-block d-lg-flex">
                        <div class="mr-3">
                          <i class="fa fa-suitcase" aria-hidden="true"></i> {{$job->company->cname}}
                        </div>
                        <div class="mr-3">
                          <i class="fa fa-home" aria-hidden="true"></i> {{str_limit($job->address,20)}}
                        </div>
                        <div>
                          <i class="fa fa-inr" aria-hidden="true"></i> {{$job->salary}}
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="col-md-12 text-center mt-5">
              <a href="{{route('alljobs')}}" class="btn btn-primary rounded py-3 px-5"><i class="fa fa-plus-circle" aria-hidden="true"></i> Show More Jobs</a>
            </div>
          </div>
        </div>
      </div>
